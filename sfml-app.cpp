...
int main()
{
    ...
    float timeBarStarWidth = 400;
    float timeBarHeight = 80;
    timeBar.setSize(Vector2f(timeBarStarWidth, timeBarHeight));
    timeBar.setFillColor(Color::Red);
    timeBar.setPosition((1920 / 2) - timeBarStarWidth / 2, 980);

    Time gameTimeTotal;
    float timeRemaining = 6.0f;
    float timeBarWidthPerSecond = timeBarStarWidth / timeRemaining;
    ...
    messageText.setString("Press Enter for start!");
    ...
    while(window.isOpen())
    {
        ...
        while(window.pollEvent(event))
        {
            ...
            if(acceptInput)
            {
                ...
                {
                    //Make sure the player is on the righ
